...
public class Board {
    private Piece @NonNull [][] pieces; // this is the underlying data structure for a board.
     ...
     * @return
     */
    public boolean apply(@NonNull Move move) {		
     ...
     * @param newPosition
     */
    public void move(@NonNull Position oldPosition, @NonNull Position newPosition) {		
    ...
    public void setPieceAt(@NonNull Position pos, @Nullable Piece piece) {
	pieces[pos.row()][pos.column()] = piece;
    }

    public @Nullable Piece pieceAt(@NonNull Position pos) {
     ...
     * @return
     */
    public boolean clearDiaganolExcept(@NonNull Position startPosition, @NonNull Position endPosition, @NonNull Piece... exceptions) {			
     ...
     * @return
     */
    public boolean clearColumnExcept(@NonNull Position startPosition, @NonNull Position endPosition, @NonNull Piece... exceptions) {			
     ...
     * @return
     */
    public boolean clearRowExcept(@NonNull Position startPosition, @NonNull Position endPosition, @NonNull Piece... exceptions) {			
	int minCol = Math.min(startPosition.column(), endPosition.column());
	int maxCol = Math.max(startPosition.column(), endPosition.column());
	int minRow = Math.min(startPosition.row(), endPosition.row());
	int maxRow = Math.max(startPosition.row(), endPosition.row());		
    ...
    private static boolean contains(@NonNull Piece p1, @NonNull Piece... pieces) {		
	for(Piece p2 : pieces) {						
	    if(p1 == p2) {									
		return true;
	    }
